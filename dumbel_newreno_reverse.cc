...
{
    std::string animFile = "dumbell_newreno_reverse.xml";
    ...
    InetSocketAddress udpSinkAddr(m_leftLeafInterfaces.GetAddress(0), 4000);
    ...
    udpSources.Add(udpSourceHelper.Install(m_rightLeaf.Get(0)));
    udpSources.Start(Seconds(1.0));
    udpSources.Stop(Seconds(10.0));

    PacketSinkHelper udpSinkHelper("ns3::UdpSocketFactory", udpSinkAddr);

    ApplicationContainer udpSinks = udpSinkHelper.Install(m_leftLeaf.Get(0));
    ...
    InetSocketAddress udpSinkAddr2(m_leftLeafInterfaces.GetAddress(2), 40000);
    ...
    udpSources2.Add(udpSourceHelper2.Install(m_rightLeaf.Get(2)));
    ...
    ApplicationContainer udpSinks2 = udpSinkHelper2.Install(m_leftLeaf.Get(2));
    ...
    flowMonitor->SerializeToXmlFile("dumbell_newreno_reverse_flow.xml", true, true);
    return 0;
}